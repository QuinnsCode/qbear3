/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 94d6323cb43069cc45fc1891162b9333)
// Runtime types generated with workerd@1.20251202.0 2025-08-21 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "SessionDurableObject" | "RealtimeDurableObject" | "GameStateDO" | "CardGameDO" | "CardCacheDO" | "SyncedStateServer" | "DraftDO" | "UserSessionDO" | "MatchmakingDO" | "CacheWarmingDO" | "VTTDO";
	}
	interface Env {
		GAME_REGISTRY_KV: KVNamespace;
		CARD_GAME_REGISTRY_KV: KVNamespace;
		DECKS_KV: KVNamespace;
		RATELIMIT_KV: KVNamespace;
		AUTH_CACHE_KV: KVNamespace;
		CARDS_KV: KVNamespace;
		WEBAUTHN_APP_NAME: "qntbr";
		...
		DISCORD_GAME_CHANNEL_ID: string;
		RESEND_API_KEY: string;
		TEST_MODE_LEMON_SQUEEZY_QNTBR_API_KEY: string;
		...
		GAME_STATE_DO: DurableObjectNamespace<import("./src/worker").GameStateDO>;
		CARD_GAME_STATE_DO: DurableObjectNamespace<import("./src/worker").CardGameDO>;
		CARD_CACHE_DO: DurableObjectNamespace<import("./src/worker").CardCacheDO>;
		CACHE_WARMING_DO: DurableObjectNamespace<import("./src/worker").CacheWarmingDO>;
		SYNCED_STATE_SERVER: DurableObjectNamespace<import("./src/worker").SyncedStateServer>;
		DRAFT_DO: DurableObjectNamespace<import("./src/worker").DraftDO>;
		USER_SESSION_DO: DurableObjectNamespace<import("./src/worker").UserSessionDO>;
		MATCHMAKING_DO: DurableObjectNamespace<import("./src/worker").MatchmakingDO>;
		VTT_DO: DurableObjectNamespace<import("./src/worker").VTTDO>;
		VTT_ASSETS: R2Bucket;
		DB: D1Database;
		ASSETS: Fetcher;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEBAUTHN_APP_NAME" | "WEBAUTHN_RP_ID" | "AUTH_SECRET_KEY" | "DISCORD_CLIENT_ID" | "DISCORD_CLIENT_SECRET" | "DISCORD_BOT_TOKEN" | "DISCORD_GUILD_ID" | "DISCORD_GAME_CHANNEL_ID" | "RESEND_API_KEY" | "TEST_MODE_LEMON_SQUEEZY_QNTBR_API_KEY" | "LEMON_SQUEEZY_WEBHOOK_SECRET" | "LEMON_SQUEEZY_STARTER_VARIANT_ID" | "LEMON_SQUEEZY_PRO_VARIANT_ID" | "STRIPE_STARTER_PRICE_ID" | "STRIPE_PRO_PRICE_ID" | "STRIPE_SECRET_KEY" | "STRIPE_PUBLISHABLE_KEY" | "STRIPE_WEBHOOK_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "BETTER_AUTH_URL">> {}
}
